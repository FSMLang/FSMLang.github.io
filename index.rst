...
The latest version is 2.2. `Revision history <_static/release_notes.html>`_ is maintained for the curious, and for those who support medical device development tool validation.  A list of released artifacts is at :doc:`Artifacts/release-index`.
